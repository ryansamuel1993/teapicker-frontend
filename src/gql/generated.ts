...
export type Query = {
  ...
  getPreferencesByUser?: Maybe<Preferences>;
...
export type QueryGetPreferencesByUserArgs = {
  userId: Scalars['ID']['input'];
};
...
export type User = {
  __typename?: 'User';
  contactNumber?: Maybe<Scalars['Int']['output']>;
...
export type AllOrdersQuery = { __typename?: 'Query', allOrders: Array<{ __typename?: 'Order', id: string, createdAt: string, completed?: boolean, orderType?: OrderType, userId?: string, teamId?: string, notes?: string }> };
...
export type OrderQuery = { __typename?: 'Query', order?: { __typename?: 'Order', id: string, createdAt: string, completed?: boolean, orderType?: OrderType, notes?: string, userId?: string, teamId?: string, ratings?: Array<{ __typename?: 'Rating', id: string, score?: Score }>, items: Array<{ __typename?: 'OrderItem', id: string, quantity: number, item: { __typename?: 'Item', id: string, name: string, price: number } }> } };
...
export type GetRatingByIdQuery = { __typename?: 'Query', getRatingById?: { __typename?: 'Rating', id: string, score?: Score, comment?: string, createdAt: string } };
...
export type GetRatingsByUserQuery = { __typename?: 'Query', getRatingsByUser: Array<{ __typename?: 'Rating', id: string, score?: Score, comment?: string }> };
...
export type GetUserQuery = { __typename?: 'Query', get?: { __typename?: 'User', id: string, name: string, email?: string } };

export type ListAllUserQueryVariables = Exact<{ [key: string]: never; }>;


export type ListAllUserQuery = { __typename?: 'Query', listAllUser: Array<{ __typename?: 'User', id: string, name: string, email?: string }> };
...
export type GetAllTeamsQuery = { __typename?: 'Query', getAllTeams: Array<{ __typename?: 'Team', id: string, name: string, members: Array<{ __typename?: 'User', id: string, name: string }> }> };
...
export const ListAllUserDocument = gql`
    query ListAllUser {
  listAllUser {
    id
    name
...
/**
 * __useListAllUserQuery__
 *
 * To run a query within a React component, call `useListAllUserQuery` and pass it any options that fit your needs.
 * When your component renders, `useListAllUserQuery` returns an object from Apollo Client that contains loading, error, and data properties
 * you can use to render your UI.
 *
 * @param baseOptions options that will be passed into the query, supported options are listed on: https://www.apollographql.com/docs/react/api/react-hooks/#options;
 *
 * @example
 * const { data, loading, error } = useListAllUserQuery({
 *   variables: {
 *   },
 * });
 */
export function useListAllUserQuery(baseOptions?: Apollo.QueryHookOptions<ListAllUserQuery, ListAllUserQueryVariables>) {
        const options = {...defaultOptions, ...baseOptions}

        return Apollo.useQuery<ListAllUserQuery, ListAllUserQueryVariables>(ListAllUserDocument, options);
      }

export function useListAllUserLazyQuery(baseOptions?: Apollo.LazyQueryHookOptions<ListAllUserQuery, ListAllUserQueryVariables>) {
          const options = {...defaultOptions, ...baseOptions}

          return Apollo.useLazyQuery<ListAllUserQuery, ListAllUserQueryVariables>(ListAllUserDocument, options);
        }

export function useListAllUserSuspenseQuery(baseOptions?: Apollo.SkipToken | Apollo.SuspenseQueryHookOptions<ListAllUserQuery, ListAllUserQueryVariables>) {
          const options = baseOptions === Apollo.skipToken ? baseOptions : {...defaultOptions, ...baseOptions}

          return Apollo.useSuspenseQuery<ListAllUserQuery, ListAllUserQueryVariables>(ListAllUserDocument, options);
        }

export type ListAllUserQueryHookResult = ReturnType<typeof useListAllUserQuery>;
export type ListAllUserLazyQueryHookResult = ReturnType<typeof useListAllUserLazyQuery>;
export type ListAllUserSuspenseQueryHookResult = ReturnType<typeof useListAllUserSuspenseQuery>;
export type ListAllUserQueryResult = Apollo.QueryResult<ListAllUserQuery, ListAllUserQueryVariables>;
